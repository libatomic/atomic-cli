...
| `--unsubscribe_behavior` | Unsubscribe cancel timing: `at_period_end` (no audience rebuild), `immediate` (rebuilds plan audiences if anything canceled, including after abort) | `at_period_end` |
